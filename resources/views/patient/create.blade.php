    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="header">New Patient</div>
                    <div class="content">
                        <form method="post" action="{{route('save_patient_record')}}">
                          {{csrf_field()}}
                            <div class="row">
                              <div class="col-md-12">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="counselling_need" rows="5" cols="80"></textarea>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="mental_counselling" rows="5" cols="80"></textarea>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="drugs_prescribed" rows="5" cols="80"></textarea>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="drugs_dispensed" rows="5" cols="80"></textarea>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="welfare_given" rows="5" cols="80"></textarea>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="lab_done" rows="5" cols="80"></textarea>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Diagnosis" name="diagnosis" class="form-control">
                                </div>
                              </div>
                            </div>
